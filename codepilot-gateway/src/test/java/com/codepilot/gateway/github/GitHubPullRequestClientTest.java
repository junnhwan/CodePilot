...
class GitHubPullRequestClientTest {
    ...
    void fetchesDiffAndMaterializedFilesFromGitHubApis() {
        ...
        GitHubPullRequestClient client = new GitHubPullRequestClient(builder, "https://api.github.com", "token-123");
        ...
        String diff = client.fetchPullRequestDiff("acme", "repo", 42);
        List<GitHubPullRequestClient.PullRequestFileSnapshot> files = client.fetchPullRequestFiles("acme", "repo", 42, "head-sha");
